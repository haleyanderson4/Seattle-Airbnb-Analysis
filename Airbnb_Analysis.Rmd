...
listings_clean <- listings_clean[,c(1:2,4:32,35:40,46,48:57,60:61,63:65)]
...
library('stargazer')
stargazer(listings_clean, out = "summary_stats.html")
# Screen shot result and add image to doc
```
